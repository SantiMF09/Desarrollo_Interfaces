...
namespace Practica2
{
    public partial class FiltrarMes : Form
    {
        public FiltrarMes()
        {
            InitializeComponent();
        ...
        private void FiltrarMes_Load(object sender, EventArgs e)
        {
        ...
        {
            this.tareaTableAdapter.FMes(this.miagendaDataSet1.tarea, Convert.ToInt32(textDia.Text), Convert.ToInt32(textAnnio.Text));
        }
